...
public class UtilTest
{
    ...
    private final static String ERROR_MESSAGE_XML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><message>Resource not found</message>";
    ...
    @Test
    public void marshalProjectTest() throws ParseException  {
    ...
    @Test
    public void parseIterationTest() throws ParseException  {
    ...
    @Test
    public void parseProjectTest() throws ParseException {
    ...
    public void errorMessageTest() {
        Object resp = APIUtil.parseEntityFromXML(new StringReader(ERROR_MESSAGE_XML));
        Assert.assertTrue(resp instanceof Message);
        Message message = (Message) resp;
        Assert.assertEquals(message.getContent(), "Resource not found");
    }
}
